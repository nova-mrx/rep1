<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
          ...
          @endcan
          @can('الاعدادات')
					<li class="side-item side-item-category">اعدادات النظام</li>
					<li class="slide">

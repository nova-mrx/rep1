...
@can('الاشعارات')	
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="\MarkAsRead_all"> الكل مقروءة</a></span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="notifications_count">  عدد الاشعارات المقروءة لديك:{{auth()->user()->unreadNotifications->count()}}</p>
									</div>
                  ...
                  <div class="mr-3">
                      ...
                      <a class="d-flex p-3" href="{{url('/invoicesDetails')}}/{{$notification->data['id']}}">
